...
def main():
    parser = argparse.ArgumentParser(description="Train PoorStar Macro-RL v3.6 competition-thinking curriculum version")
    ...
    parser.add_argument("--checkpoint-dir", default="checkpoints_v28")
    ...
    parser.add_argument("--rl-start-time", type=float, default=420.0)
    ...
    print("=" * 100)
    print("TRAIN MACRO-RL V3.6 SUMMARY/SCRIPT HOTFIX")
    ...
    print(f"opening_time         : {args.opening_time}")
    print(f"rl_start_time        : {args.rl_start_time}  # internal clamp may keep competition >= 420")
    ...
    print(f"resign_min_time      : {args.resign_min_time}")
    print(f"game_time_limit      : {args.game_time_limit if args.game_time_limit and args.game_time_limit > 0 else None}")
